#ifndef TESTWOUNDHEALINGINGINTOPDOWNGEOMETRY_HPP_
#define TESTWOUNDHEALINGINGINTOPDOWNGEOMETRY_HPP_
...
class TestTopDownWoundHealing : public AbstractCellBasedTestSuite
{
public:
    void TestWounding()
    {
...
#endif /* TESTWOUNDHEALINGINGINTOPDOWNGEOMETRY */