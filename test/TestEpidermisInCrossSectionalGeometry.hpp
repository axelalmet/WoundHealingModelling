...
static const double M_SS_SAMPLING_TIMESTEP = 0.05*M_END_TIME/M_DT;
...
public:
    ...
    //     double bm_stiffness = 1.0; // Basement membrane attachment strength
    //     // double target_curvature = 0.0; // Target curvature

    //     // Set the probability of being an EPF fibroblast.
    //     double epf_fibroblast_probability = 1.0;

    //     // Set the probability of symmetric division
    //     // double symmetric_division_probability = 0.75;
